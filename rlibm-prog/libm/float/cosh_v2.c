...
float rlibm_fast_cosh_v2(float x) {
  float_x fx;
  fx.f = x;
  fx.x &= 0x7FFFFFFF;
  ...
  if (R == 1.0487717054569856145462836138904094696044921875e-02) {
    coshL = 1.000054996608601864949150694883428514003753662109375;
  } else {
    // For the rest of them, use polynomial
    coshL = 4.166666081404267474308511509661911986768245697021484375e-02;
    coshL *= R2;
    coshL += 4.99999999973159636734720834283507429063320159912109375e-01;
    coshL *= R2;
